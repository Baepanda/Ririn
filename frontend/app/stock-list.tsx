...
import { ScreenContainer, AppHeader, formatIDR, EmptyState, LoadingView, Badge } from "@/src/components/ui";
  ...
  return (
    <ScreenContainer>
      ...
      {isLoading ? (
        ...
        <EmptyState icon={<Package size={40} color={colors.muted} />} title="Tidak ada barang" />
      ) : (
        <FlatList
          data={filtered}
          keyExtractor={(i) => i.id}
